...
#define FOREGROUND_STAR_IMAGE_NAME @"star1"
#define BACKGROUND_STAR_IMAGE_NAME @"star-0"
...
- (void)userTapRateView:(UITapGestureRecognizer *)gesture {
    ...
    self.currentP = starScore / self.numberOfStars;
    self.scorePercent = starScore / self.numberOfStars * self.numberOfStars;
}
